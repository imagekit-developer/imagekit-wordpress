<?php
/**
 * Represents a single setting node point.
 *
 * @package   ImageKitWordpress\Settings
 */

namespace ImageKitWordpress\Settings;
...
class Setting {
	...
	public function get_submitted_value() {
		...
		if ( is_null( $value ) && 'input' === $this->get_param( 'type' ) ) {
