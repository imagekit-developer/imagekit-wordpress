<?php
/**
 * REST_API is the parent component for the ImageKitWordpress plugin endpoints.
 *
...
class REST_API {
	...
	public function rest_api_init() {
		...
		$this->endpoints = apply_filters( 'imagekit_api_rest_endpoints', array() );
